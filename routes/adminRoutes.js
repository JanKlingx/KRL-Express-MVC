...
router.get('/lmu-car-assignments', asyncHandler(lmuCarAssignmentController.show));
router.post('/lmu-car-assignments', asyncHandler(lmuCarAssignmentController.save));

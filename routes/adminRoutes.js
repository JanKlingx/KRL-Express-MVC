...
router.post('/season-setup/:seasonId/calendar/reorder', asyncHandler(seasonSetupController.reorderCalendar));
router.post('/season-setup/:seasonId/calendar/:eventId/update', asyncHandler(seasonSetupController.updateCalendarEvent));
router.post('/season-setup/:seasonId/calendar/:eventId/delete', asyncHandler(seasonSetupController.removeCalendarEvent));

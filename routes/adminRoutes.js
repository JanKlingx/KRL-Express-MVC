...
router.post('/news/:id', upload.single('image'), asyncHandler(require('../controllers/communityController').saveNews));
...
router.post(
  "/penalty-ledger/settings",
  asyncHandler(penaltyLedgerController.updateSettings),
);
